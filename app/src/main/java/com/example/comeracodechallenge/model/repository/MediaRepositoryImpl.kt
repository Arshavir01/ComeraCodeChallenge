...
class MediaRepositoryImpl(private val context: Context): MediaRepository {
    ...
    override val loadingStatus: SharedFlow<Status>
        get() = _loadingStatus.asStateFlow()

    private val mutex = Mutex(false)

    override suspend fun getAllMedia(): List<LocalMedia> =
        withContext(Dispatchers.IO) {
            ...
            mutex.withLock {
                ...
                try {
                    ...
                    this@MediaRepositoryImpl.mediaList.addAll(
    ...
    override fun getAllMediaWithFolders(): List<Folder> {
    ...
    override fun getAllMediaFromFolders(): List<LocalMedia> {
        val allMedia = mediaFolders?.flatMap { it.folderItemList }
        return allMedia?.distinct() ?: emptyList()
    }

    override fun getMediaForFolderId(folderId: Int): List<LocalMedia> {
